...
If your change touches credentials, provider connectors, reports, local logs, Slack webhooks, browser API routes, or local AI CLI usage parsing, include a `Security impact` section in the pull request.
